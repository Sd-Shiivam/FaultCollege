...
from .views import home, logout,student_dashboard,add_edit_lecture,forget_pass,student_login,student_signup, teacher_dashboard, teacher_login, teacher_signup
