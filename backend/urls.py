...
from .views import home, logout, roborts_view, show_students,student_dashboard,add_edit_lecture,forget_pass,student_login,student_signup, teacher_dashboard, teacher_login, teacher_signup
...
urlpatterns = [
    ...
    path("teacher/student_list",show_students,name="show_students"),
